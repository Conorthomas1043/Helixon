// Inline SVG icons (24x24, stroke-based, Lucide-style) so the console needs no
// icon package. <Icon name="users" /> inherits the surrounding text colour.
...
const PATHS = {
  ...
  sparkles: <path d="M9.94 14.06 8 20l-1.94-5.94L0 12l6.06-2.06L8 4l1.94 5.94L16 12zM19 3v4M21 5h-4M19 17v4M21 19h-4" />,
...
export function Icon({ name, size, className = "", strokeWidth = 2, ...rest }) {
