...
function FloatField({ id, label, type = "text", value, onChange, error, autoComplete, textarea = false, required = true }) {
  ...
  return (
    ...
    >
      ...
      <Tag
        ...
        style={{
          color: "var(--ink)",
          padding: active ? "22px 14px 8px" : textarea ? "14px" : "14px",
            ...
            {success ? (
              ...
              <>
                ...
                <p className="text-[13.5px] leading-relaxed mb-7" style={{ color: "var(--ink-soft)" }}>
                  Tell us a bit about your team and we&apos;ll walk you through how Helixon
                  fits into your screening process.
                </p>

                {error && (
                  <div role="alert" aria-live="assertive" className="mb-4 flex items-start gap-2.5 p-3 rounded-[10px]" style={{ background: "#fef2f2", border: "1px solid #fecaca" }}>
