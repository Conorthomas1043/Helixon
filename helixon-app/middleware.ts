...
// IMPORTANT: this must be `middleware` (or a default export) — Next.js
// looks for that exact name to wire this file up. The previous version of
// this file exported `proxy`, which Next.js does not recognize, so none of
// the logic below (dev gate, IP blocking, trial gating) was ever running.
// If you already have a separate real `middleware.ts` re-exporting a
// `proxy` function from elsewhere, replace that indirection with this file
